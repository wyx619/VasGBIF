...
stars](https://img.shields.io/github/stars/wyx619/VasGBIF.svg?style=social&label=Star&maxAge=2592000)![](https://img.shields.io/badge/version-3.7.0-blue?logo=R)
...
4.  **Customized Filter** (`customized_filter`): Joins the imported
...
5.  **Clean Coordinates** (`clean_coordinates`): Validates coordinates
    with
    [CoordinateCleaner](https://doi.org/10.32614/CRAN.package.CoordinateCleaner)
