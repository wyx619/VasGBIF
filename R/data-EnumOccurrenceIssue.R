...
#'
#' There are many things that can go wrong and we continuously encounter unexpected data.
...
#' Some merely flag the fact that GBIF has altered values during processing.
