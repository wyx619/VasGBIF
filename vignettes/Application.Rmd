...
7.  **Map Records** — **`map_records()`** renders the records on an interactive map with geohash-based decluttering
8.  **Export Records** — **`export_records()`** writes the classified records to two gzip-compressed CSV files
